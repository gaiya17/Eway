...
export function CTASection({ onRegisterClick, onLoginClick }: CTASectionProps) {
  return (
          ...
          <div className="relative p-12 md:p-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button 
                ...
                className="group px-8 py-4 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-400 text-white font-semibold hover:shadow-[0_0_32px_rgba(99,102,241,0.6)] transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
              >
                Register Now
